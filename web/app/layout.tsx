...
export const metadata: Metadata = {
  title: 'Printer Fleet Manager',
  description: 'Manage and monitor your printer fleet with SNMP',
}
                  ...
                  <div className="hidden sm:ml-8 sm:flex sm:space-x-1">
                    ...
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 5a2 2 0 012-2h4a2 2 0 012 2v0M8 5a2 2 0 000 4h8a2 2 0 000-4M8 5v4h8V5" />
                      </svg>
                      Dashboard
                    </a>
                    <a
            ...
            <div className="max-w-full mx-auto py-6 px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center">
                <div className="text-sm text-gray-500">
                  © 2025 Printer Fleet Manager. Built with Next.js & FastAPI.
                </div>
