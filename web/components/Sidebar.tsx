...
export default function Sidebar({ isCollapsed }: SidebarProps) {
  ...
  const getNavClasses = (path: string) => {
    ...
    if (isActive(path)) {
      return `${baseClasses} ${collapsedClass} bg-accent-light text-accent`
    }
    return `${baseClasses} ${collapsedClass} text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-accent`
  }

  return (
    <aside className={`fixed left-0 top-0 z-40 h-screen border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all duration-300 ${
      ...
      <div className="flex h-full flex-col overflow-y-auto p-4">
        ...
        <div className={`mb-8 flex items-center gap-2 px-3 ${isCollapsed ? 'justify-center' : ''}`}>
          ...
          {!isCollapsed && <span className="text-lg font-bold text-gray-900 dark:text-white">PrinterFleet</span>}
        </div>
        ...
        <nav className="flex-1 space-y-1">
          ...
          <div className="mb-4">
            ...
            >
              ...
              {!isCollapsed && <span>Printers</span>}
            </Link>
          ...
          <div className="mb-4">
            ...
            >
              ...
              {!isCollapsed && <span>Supply Requests</span>}
            </Link>

            <Link
              href="/printing-history"
              className={getNavClasses('/printing-history')}
              title="Printing History"
            >
              <svg className="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              {!isCollapsed && <span>Printing History</span>}
            </Link>
          </div>
